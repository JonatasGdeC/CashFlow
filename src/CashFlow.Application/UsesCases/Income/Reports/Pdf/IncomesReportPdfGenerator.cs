...
using CashFlow.Application.UsesCases.Expense.Reports;
...
public class IncomesReportPdfGenerator(RequestFilterJson request, List<Domain.Enitites.Income> incomes) : GenerateReportPdf<Domain.Enitites.Income>
{
    ...
    protected override void TotalSpendSection(Section section)
    {
        ...
        decimal totalExpense = incomes.Sum(selector: expense => expense.Amount);
    ...
    protected override void AddTableHeader(Table table, Domain.Enitites.Income item)
    {
    ...
    protected override void AddTableBody(Table table, Domain.Enitites.Income item)
    {
        Row row = table.AddRow();
        row.Height = 25;
    ...
    protected override void AddTableFooter(Table table, Domain.Enitites.Income item)
    {
    ...
    public byte[] Execute() => Build(request: request, items: incomes);
}