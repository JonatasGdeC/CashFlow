...
namespace CashFlow.App.Pages.Expenses.Components.ExpenseReportModal;

public partial class ExpenseReportModal
{
    ...
    private string _title = "Despesas";
    ...
    private async Task DownloadPdfAsync()
    {
        ...
        List<string>? feedbacks = await downloadReport.Execute(generateReport: ExpenseApiService.GetPdf,
    ...
    private async Task DownloadExcelAsync()
    {
        ...
        DownloadReport downloadReport = new(jsRuntime: JsRuntime, filterRequest: _reportRequest);
        List<string>? feedbacks = await downloadReport.Execute(generateReport: ExpenseApiService.GetExcel,
